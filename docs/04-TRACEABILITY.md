...
| FR-32 | C5,C6 | services/dashboard/explorer (filter/compose + overlap law), web/routes_explorer, templates/app/explore.html, help_registry (explore destination) | tests/test_explorer.py — T-EXP-F-01..09 mapped in module docstring (reconciliation, overlap-once, purged-labeled, tier honesty, FR-30, scoping, jargon law) | — |
